        ...
        <View className="flex-1 justify-center items-center bg-black/80 px-10">
          <View className="bg-[#1E1E1E] w-full rounded-[40px] p-8 items-center border border-white/10 shadow-2xl">
            ...
            <View className={`w-20 h-20 rounded-full items-center justify-center mb-6 
              ...
              <Ionicons 
                name={data.type === 'success' ? "checkmark-done" : data.type === 'error' ? "close" : "warning"} 
                size={40} 
            ...
            <TouchableOpacity 
              onPress={handleClose}
              activeOpacity={0.8}
              className="bg-[#FACC15] w-full py-5 rounded-full items-center shadow-lg shadow-yellow-500/20"
            >
              <Text className="text-black font-black text-lg uppercase tracking-wider">Got it</Text>
            </TouchableOpacity>
          </View>
        </View>
      </Modal>
